...
ACTIVITIES = [
    discord.Activity(type=discord.ActivityType.playing, name="Purupuru Pururin~ 🎶"),
    discord.Activity(
        type=discord.ActivityType.watching,
        name="Satou spiral into conspiracy theories 👀",
    ),
    discord.Activity(type=discord.ActivityType.listening, name="Moe tunes on loop 💿"),
    discord.Activity(
...
class ActivityRotator(commands.Cog):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.activities = itertools.cycle(ACTIVITIES)
